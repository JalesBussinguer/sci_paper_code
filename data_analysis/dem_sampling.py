...
pnb = gpd.read_file('D:/thesis_data/ROI/PNB_32723.GEOJSON')
...
df_dem = pd.DataFrame({'dem': dem.flatten()})
df_dem.dropna(inplace=True)

df_dem.to_csv('D:/thesis_data/TOPOGRAPHY/slope_pnb_samples.csv', sep=',', index=False)
