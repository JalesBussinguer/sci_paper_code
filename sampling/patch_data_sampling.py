...
form_florestal = gpd.read_file('D:/thesis_data/ROI/sampling/FF_sampling_grid_30m_32723.GEOJSON')
florestal_geom = [geom for geom in form_florestal.geometry]

form_savanica = gpd.read_file('D:/thesis_data/ROI/sampling/FS_sampling_grid_30m_32723.GEOJSON')
savanica_geom = [geom for geom in form_savanica.geometry]

form_campestre = gpd.read_file('D:/thesis_data/ROI/sampling/FC_sampling_grid_30m_32723.GEOJSON')
