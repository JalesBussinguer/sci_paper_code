...
files_path = 'D:/thesis_data/VEG_INDICES/samples/stratified/campestre/20m/'

output_path = 'D:/thesis_data/VEG_INDICES/lognorm_params/campestre/'
...
for index, file in enumerate(files_list):
    ...
    result.to_csv(output_path + 'FC_' + date + '_ln_params.csv', sep=',', index=False)
